...
OTHER_HEADER_DIRS = Additions Base WidgetBackends WidgetBackends/AppKit ActionHandlers ItemFactoryAdditions Layouts Tools AspectRepository ModelBuilder CoreObjectUI Persistency UIBuilder
