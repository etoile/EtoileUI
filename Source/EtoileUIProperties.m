...
NSString * const kETHasValidRepresentedPathBaseProperty = @"hasValidRepresentedPathBase";
...
NSString * const kETIndexPathProperty = @"indexPath";
NSString * const kETInspectorProperty = @"inspector";
NSString * const kETIsBaseItemProperty = @"isBaseItem";
...
NSString * const kETPathProperty = @"path";
...
NSString * const kETRepresentedPathBaseProperty = @"representedPathBase";
NSString * const kETRepresentedPathProperty = @"representedPath";
